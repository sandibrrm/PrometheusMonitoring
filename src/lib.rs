// src/lib.rs
/*
 * Core library for PrometheusMonitoring
 */
...
#[derive(Debug)]
pub struct PrometheusMonitoringProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrometheusMonitoringProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrometheusMonitoring processing");
    
    let mut processor = PrometheusMonitoringProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrometheusMonitoringProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrometheusMonitoringProcessor::new(false);
